...
class MemoryOperandTest {
    ...
    public void testGetDescriptionOnlyDisplacement() {
        ...
        assertEquals("memory at address 0x1000 (effective address = displacement 0x1000)",
                op1.getDescription(state, labelManager));

        // Label displacement
        MemoryOperand op2 = new MemoryOperand("my_var");
        assertEquals("memory at address 0x3000 (effective address = address of label my_var)",
    ...
    public void testGetDescriptionRIPRelative() {
        ...
        assertEquals("memory at address 0x3000 (effective address = RIP-relative label my_var)",
        ...
        assertTrue(desc.contains("effective address = %rip + 3"));
    }
    ...
    public void testGetDescriptionBaseOnly() {
        ...
        assertEquals("memory at address 0x1000 (effective address = displacement[0] + base[%rax])",
    ...
    public void testGetDescriptionBaseIndexDisplacement() {
        ...
        assertTrue(op.getDescription(state, labelManager)
                .contains("effective address = displacement[2] + base[%rax] + (index[%rcx] * scale[1])"));
    }
}